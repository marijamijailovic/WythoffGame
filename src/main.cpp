...
int main() {
  ...
  cin >> option;
  if (option == 'y') {
    cout << "To calculate the time for the p_position depeneds by n enter A, "
         << endl;
    cout << "To calculate time for the p_position depends by a enter B, "
         << endl;
  ...
  cout << "There three way how we can calculate P-Position table (please "
          "choose the one of the option)"
       << endl;
